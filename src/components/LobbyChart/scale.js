...
export function getScaleInfo (style, winSize, roomDim) {
    ...
    let activeWidthUNIT = roomDim.x + style.initialZoomViewMinMargin * 2;
    let activeHeightUNIT = roomDim.y + style.initialZoomViewMinMargin * 2;
    let unitPX = NaN;
